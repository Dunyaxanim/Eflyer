        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route($routeName.'create') }}">Create new</a></li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete all Products?</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        If you implement this process, all your products will be deleted.
                      </div>
                      <div class="modal-footer">
                         <form action="{{ route($routeName.'destroyAll') }}" method="post">
                          @method('delete')
                          @csrf
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($model as $key => $data)
                    <tr>
                      <td><img style="height: 70px; width:70px; margin:auto;" src="" alt=""></td>
                      <td>{{$data->name}}</td>
                      <td>{{$data->price}}</td>
